    ...
    <div className="flex w-screen bg-gray-50">
      ...
      <main className="flex-1 overflow-hidden">
        ...
        <div className="flex h-full flex-col">
          ...
          <h1 className="text-xl font-bold mx-auto max-w-2xl  mb-2">
            Upload  documents
        </h1>
        ...
        <Tabs defaultValue="upload" className="max-w-3xl mx-auto">
          ...
          <TabsContent value="upload">
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-12 text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">Drag and Drop or Browse files</h3>
              <p className="text-sm text-gray-500 mb-4"> supports .pdf document formats</p>
